...
dag = DAG(
    dag_id='currency_data_etl_Pipeline_FINAL_TEST_RD_TableCreation',
...
def create_currency_table():
    try:
        ...
        cur.execute("""CREATlE TABLE IF NOT EXISTS currency_data_table(Date_Extracted DATE, Amount int, Base varchar(20), Rates float, Currency varchar(20))""")
        conn.commit()
